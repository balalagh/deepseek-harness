...
function extractLlmRequests(events) {
  const requests = [];
  // pending accumulates system/message, user/message, etc. across all events.
  // On each request/header we snapshot it, then continue accumulating.
  ...
  for (const e of events) {
    if (e.type === "system/message") {
      ...
      // user/message stores the message directly in data (not nested under .message)
